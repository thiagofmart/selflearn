...
def elastic_collision():
    ...
    """+javascript, height=plane_dim[1]+plane_dim[1]*0.2+4)


posts = ["Elastic Collision", "Innelastic Collision"]
st.markdown("""
# Physics Page
---

Here you can see some posts about physics:

"""
)
elastic_collision_tab, inelastic_collision_tab = st.tabs(posts)


with elastic_collision_tab:
    elastic_collision()

with inelastic_collision_tab:
    st.markdown("some content here")
